...
// CUSTOM MENU DASHBOARD MEMBERS
function wpbt_custom_new_menu1() {
    register_nav_menus(
        array(
            'my-custom-menu1' => __( 'Menu Dashboard Members' ),
            'extra-menu' => __( 'Menu Show Profile Dashboard Members' )
        )
    );
}
add_action( 'init', 'wpbt_custom_new_menu1' );

// function wpbt_custom_new_menu2() {
